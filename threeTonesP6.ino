...
const unsigned long rewardDeliveryDurationMsec = 100;
...
const int TTL_EVT_TONE3_ON                 = 93;
const int TTL_EVT_TONE3_FREQ               = 94;
const int TTL_EVT_TONE3_DURATION           = 95;
const int TTL_EVT_TONE3_OFF                = 96;
